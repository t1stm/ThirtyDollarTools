...
Sundex is the custom game engine and UI framework used by the Thirty Dollar Visualizer. It is built on top of OpenTK and
provides a set of tools for 2D rendering, asset management, and styling.
...
A Domain Specific Language for styling Sundex components, providing a clean and declarative way to define visual
properties.
