...
public interface IGPUBuffer<TDataType> : IBuffer, IDisposable where TDataType : unmanaged
{
    ...
    /// <summary>
    ///     Provides indexed access to data within a GPU buffer, allowing retrieval and modification of individual elements at
    ///     the specified index.
    ///     Accessing or setting values using this property directly interacts with the internal buffer or its update
    ///     mechanism.
    /// </summary>
