...
public class AssetProvider
{
    ...
    /// </summary>
    /// <typeparam name="TReturn">The type of asset to be queried, which implements <see cref="ILoadableAsset&lt;TReturn, TCreate&gt;"/>.</typeparam>
    ...
    /// </summary>
    /// <typeparam name="TReturn">The type of asset to be loaded, which implements <see cref="ILoadableAsset&lt;TReturn, TCreate&gt;"/>.</typeparam>
    ...
    /// </summary>
    /// <typeparam name="TReturn">The type of the assets to be loaded, which implements <see cref="ILoadableAsset&lt;TReturn, TCreate&gt;"/>.</typeparam>
    /// <typeparam name="TCreate">The type of the creation information required to load the assets.</typeparam>
    /// <param name="destination">The destination span where the loaded assets will be stored. Its length must be at least equal to the number of provided creation information entries.</param>
    /// <param name="createInfos">A collection of creation information entries that define how each corresponding asset should be loaded.</param>
    /// <exception cref="ArgumentException">Thrown when the length of the destination span is smaller than the number of provided creation information entries.</exception>
    ...
    public TReturn[] Load<TReturn, TCreate>(params ReadOnlySpan<TCreate> createInfos) where TReturn : ILoadableAsset<TReturn, TCreate>
    {
