...
public static class Asset
{
    ...
    /// </summary>
    /// <param name="assetPath">The path of the asset as seen in the source code after <see cref="ThirtyDollarVisualizer.Assets"/></param>
    ...
    public static string Embedded(string assetPath)
    {
        ...
        return File.Exists(location)
            ...
            : throw new FileNotFoundException(
                $"Unable to find asset '{location}' in real path. " +
                "Maybe you forgot to copy it to the build directory? " +
                "(This step should be done automatically by the build step " +
