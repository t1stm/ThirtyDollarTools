...
public readonly struct PlayfieldSettings(float renderable_size, string download_location, float render_scale = 1f, int sounds_on_a_single_line = 16, int sound_size = 64, int sound_margin = 6)
{
    /// <summary>
