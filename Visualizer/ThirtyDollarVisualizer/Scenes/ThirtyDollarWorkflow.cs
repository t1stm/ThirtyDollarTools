...
public class ThirtyDollarWorkflow
{
    ...
    public AtlasStore? AtlasStore { get; set; }
    ...
    public ThirtyDollarWorkflow(Game game, AudioContext? context = null,
    ...
    /// </summary>
    public async Task CreateSampleHolder()
    {
    ...
    protected void LoadTextureAtlas(SampleHolder sampleHolder)
    {
        try
        {
            ...
            var atlases = new AtlasStore(null!); // TODO: complete
    ...
    public async Task<SampleHolder> GetSampleHolder()
    {
        try
        {
    ...
    public virtual async Task UpdateSequences(string?[] locations, bool restartPlayer = true)
    {
