...
public static class RootPlanes
{
    ...
    public static AnimatedPlane<GradientPlane>[] GenerateRootPlanes(UIContext context)
    {
        ...
        var animations = new[]
        {
            new AnimatedPlane<GradientPlane>(g1, new KeyframedAnimation([
                new Keyframe
                {
            ...
            new AnimatedPlane<GradientPlane>(g2, new KeyframedAnimation([
                new Keyframe
                {
            ...
            new AnimatedPlane<GradientPlane>(g3, new KeyframedAnimation([
                new Keyframe
                {
            ...
            new AnimatedPlane<GradientPlane>(g4, new KeyframedAnimation([
                new Keyframe
                {
                    Position = new Vector3(0, viewportY / 2f, 0),
                    LengthMs = 7500,
            ...
            new AnimatedPlane<GradientPlane>(g5, new KeyframedAnimation([
                new Keyframe
                {
                    Position = new Vector3(0, -viewportY / 2f, 0),
                    LengthMs = 7500,
            ...
            new AnimatedPlane<GradientPlane>(g6, new KeyframedAnimation([
                new Keyframe
                {
                    Position = new Vector3(0, viewportY / 2f, 0),
                    LengthMs = 7500,
        ...
        foreach (var animatedPlane in animations)
        {
    ...
    public static void PositionGradients(AnimatedPlane<GradientPlane>[] gradients, float viewportWidth,
