...
ctx.Playhead         = Component.RegisteredIDs["playhead"]          as Panel       ?? throw new Exception("playhead not found");
ctx.LeftGroup        = Component.RegisteredIDs["left-group"]        as FlexPanel   ?? throw new Exception("left-group not found");
