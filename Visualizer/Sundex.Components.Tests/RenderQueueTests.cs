...
public class RenderQueueTests
{
    private class TestUIContext : UIContext
    {
        ...
        public TestUIContext()
        {
            ...
            Camera = new DollarStoreCamera(OpenTK.Mathematics.Vector3.Zero, new OpenTK.Mathematics.Vector2i(800, 600));
        }
    ...
    public void TestDequeueRender_Found()
    {
        ...
        int index = context.DequeueRender(renderable1, 0);
    ...
    public void TestDequeueRender_NotFound()
    {
        ...
        int index = context.DequeueRender(renderable2, 0);
    ...
    private class TestElement(UIContext context) : UIElement(context)
    {
        ...
        public new int Index { get => base.Index; set => base.Index = value; }

        [RenderPriority(0)]
        public Renderable? Background { get; set; }

        [RenderPriority(99)]
        public Renderable? Foreground { get; set; }
    }
    ...
    public void TestHoverStateChange_NoDuplicatesInQueue()
    {
        ...
        holder.Components["panel"] = new Dictionary<string, IStyleValue>
        {
            ...
            { "state[hovered]", new BlockValue(new Dictionary<string, IStyleValue> { { "background", new ColorValue("#000000") } }) }
        };
    ...
    public void TestHandleRenderableSwap_BackgroundFallbackToIndexZero()
    {
        ...
        var newBackground = new MockRenderable();
        element.Background = newBackground; // This will trigger ApplyStyleValue or we can call HandleRenderableSwap directly
    ...
    public class TestPanel : Panel
    {
        ...
        public new int Index { get => base.Index; set => base.Index = value; }
        public void TestHandleRenderableSwap(object? oldV, object? newV, string? propName = null) => HandleRenderableSwap(oldV, newV, propName);
    }
